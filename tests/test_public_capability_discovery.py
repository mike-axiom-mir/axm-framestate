...
class PublicCapabilityDiscoveryTests(unittest.TestCase):
    def test_committed_artifacts_are_exact_and_source_backed(self) -> None:
        ...
        self.assertEqual(record["runtime"]["externalPythonPackages"], [])
        ...
        self.assertEqual(record["contracts"]["currentCliImportBoundary"], "dependency-free-core-lazy-optional-media-v0.16")
        self.assertEqual(
            record["authority"],
            {
                "discoveryOnly": True,
        ...
        self.assertEqual(receipt["truth_boundary"]["current_cli_external_python_boundary"], [])
